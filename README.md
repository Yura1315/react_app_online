...
Страницы приложения: 1. Главная, 2. Каталог, 3. Корзина, 4. Авторизация, регистрация, 5. Личный кабинет, 6. 404 not found, добавить функционал личного кабинета для гостя.
